...
while iter < itermax:
    ...
    for i in range(numant):
        ...
        for j in range(1, numcity):  # 循环numcity-1次，访问剩余的numcity-1个城市
            ...
            k = listunvisited[[i for i, x in enumerate(cumsumprobtrans) if x > 0][0]]
...
for i in range(numcity - 1):  #
    ...
    # print([m, n])
    plt.plot(
        [coordinates[m][0], coordinates[n][0]],
        [coordinates[m][1], coordinates[n][1]],
        "k",
    )
# print(n)
# plt.plot(
#     [coordinates[bestpath[0]][0], coordinates[n][0]],
#     [coordinates[bestpath[0]][1], coordinates[n][1]],
#     "b",
# )


start = int(bestpath[0])
end = int(bestpath[-1])
# print([start, end])
plt.plot(
